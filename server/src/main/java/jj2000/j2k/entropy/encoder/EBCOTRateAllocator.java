...
public class EBCOTRateAllocator extends PostCompRateAllocator
{
	...
	public EBCOTRateAllocator(final CodedCBlkDataSrcEnc src, final LayersInfo lyrs, final CodestreamWriter writer, final EncoderSpecs encSpec,
	 ...
	 */
	private void findTruncIndices(final int layerIdx, final int compIdx, final int lvlIdx, final int tileIdx, final SubbandAn subb, final float fthresh,
