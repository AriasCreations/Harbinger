...
public abstract class LookUpTable8 extends LookUpTable
{
	...
	protected LookUpTable8(final int dwNumInput, // Number of i nput values in created
						   // LUT
	 ...
	 * @return the lut as a String
	 */
	protected LookUpTable8(final ICCCurveType curve, // Pointer to the curve data
