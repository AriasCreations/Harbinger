...
public class LookUpTable32LinearSRGBtoSRGB extends LookUpTable32
{
	 ...
	 * @return the lut
	 */
	public static LookUpTable32LinearSRGBtoSRGB createInstance(final int inMax, final int outMax, final double shadowCutoff,
	 ...
	 *
	 */
	protected LookUpTable32LinearSRGBtoSRGB(final int inMax, final int outMax, final double shadowCutoff, double shadowSlope,
