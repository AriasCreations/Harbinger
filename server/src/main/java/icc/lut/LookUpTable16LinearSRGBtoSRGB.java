...
public class LookUpTable16LinearSRGBtoSRGB extends LookUpTable16
{
	 ...
	 * @return the lut
	 */
	public static LookUpTable16LinearSRGBtoSRGB createInstance(final int wShadowCutoff, final double dfShadowSlope,
	 ...
	 *            post shadow region parameter
	 */
	protected LookUpTable16LinearSRGBtoSRGB(final int wShadowCutoff, final double dfShadowSlope, final int ksRGBLinearMaxValue,
