...
public class QuantStepSizeSpec extends ModuleSpec {
	 ...
	 */
	public QuantStepSizeSpec ( final int nt , final int nc , final byte type ) {
		super ( nt , nc , type );
	}
	 ...
	 */
	public QuantStepSizeSpec ( final int nt , final int nc , final byte type , final ParameterList pl ) {
		super ( nt , nc , type );

		final String param = pl.getParameter ( "Qstep" );
		if ( null == param ) {
		...
		if ( null == getDefault ( ) ) {
			...
			if ( 0 != ndefspec ) {
				this.setDefault ( Float.parseFloat ( pl.getDefaultParameterList ( ).getParameter ( "Qstep" ) ) );
			}
			else {
