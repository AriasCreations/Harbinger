...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.fileformat.writer.*;
...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.image.input.*;
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.roi.encoder.*;
	...
	public void run()
	{
		...
		try
		{
			...
			if (useFileFormat)
			{
				...
				if (!outext.equalsIgnoreCase(".jp2"))
				{
