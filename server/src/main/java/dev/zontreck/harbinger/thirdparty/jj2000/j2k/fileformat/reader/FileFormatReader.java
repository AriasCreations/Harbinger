...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.fileformat.*;
...
public class FileFormatReader implements FileFormatBoxes
{
	...
	public void readFileFormat() throws IOException {
		...
		try
		{
			...
			if (0x0000000c != in.readInt() || JP2_SIGNATURE_BOX != in.readInt() || 0x0d0a870a != in.readInt())
			{ // Not a JP2 file
				this.in.seek(0);
