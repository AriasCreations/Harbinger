...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.icc.lut.MatrixBasedTransformException;
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.icc.lut.MatrixBasedTransformTosRGB;
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.icc.lut.MonochromeTransformException;
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.icc.lut.MonochromeTransformTosRGB;
...
public class ICCProfiler extends ColorSpaceMapper {
	...
	private final Object xform;
	/**
	 * The image's ICC profile.
	 */
	private final RestrictedICCProfile iccp;
	// ICCProfiles.
	 ...
	 * @throws IOException         profile access exception
	 * @throws ICCProfileException profile content exception
	 */
	 ...
	 *
	 * @param csm provides all necessary info about the dev.zontreck.harbinger.thirdparty.jj2000.j2k.colorspace
