...
public abstract class AnWTFilterInt extends AnWTFilter {
	...
	public abstract void analyze_lpf (
			int[] inSig , int inOff , int inLen , int inStep , int[] lowSig , int lowOff ,
	 ...
	 *
	 * @param inSig    This is the array that contains the input signal. It must be
	 *                 an int[].
	 * @param inOff    This is the index in inSig of the first sample to filter.
	 * @param inLen    This is the number of samples in the input signal to filter.
	 * @param inStep   This is the step, or interleave factor, of the input signal
	...
	public void analyze_lpf (
		...
		this.analyze_lpf ( ( int[] ) inSig , inOff , inLen , inStep , ( int[] ) lowSig , lowOff , lowStep , ( int[] ) highSig , highOff ,
				highStep
		);
	}
	...
	public void analyze_hpf (
		...
		this.analyze_hpf ( ( int[] ) inSig , inOff , inLen , inStep , ( int[] ) lowSig , lowOff , lowStep , ( int[] ) highSig , highOff ,
				highStep
		);
	}
