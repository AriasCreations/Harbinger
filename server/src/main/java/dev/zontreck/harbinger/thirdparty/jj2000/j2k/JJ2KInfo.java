...
public enum JJ2KInfo {
	 ...
	 */
	public static final String copyright = "This software module was originally developed by Rapha�l Grosbois "
			...
			+ "David Bouchard, F�lix Henry, Gerard Mozelle and Patrice Onno (Canon Research Centre "
	 ...
	 */
	public static final String bugaddr = "dev.zontreck.harbinger.thirdparty.jj2000-bugs@ltssg3.epfl.ch";
}
