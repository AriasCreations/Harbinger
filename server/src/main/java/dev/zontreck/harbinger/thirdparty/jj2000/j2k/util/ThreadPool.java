...
public class ThreadPool {
	 ...
	 * dev.zontreck.harbinger.thirdparty.jj2000.j2k.util.ThreadPool.concurrency
	 */
	public static final String CONCURRENCY_PROP_NAME = "dev.zontreck.harbinger.thirdparty.jj2000.j2k.util.ThreadPool.concurrency";
	...
	class ThreadPoolThread extends Thread {
		 ...
		 * @param lock      An object on which notify will be called once the target's
