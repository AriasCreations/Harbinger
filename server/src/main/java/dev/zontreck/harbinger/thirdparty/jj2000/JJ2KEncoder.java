 ...
 * CVS identifier:
 *
 * $Id: dev.zontreck.harbinger.thirdparty.jj2000.JJ2KEncoder.java,v 1.10 2001/10/26 12:31:43 grosbois Exp $
 *
 * Class:                   dev.zontreck.harbinger.thirdparty.jj2000.JJ2KEncoder
 *
...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.encoder.CmdLnEncoder;

/**
 * This class is a wrapper for the CmdLnEncoder class in the dev.zontreck.harbinger.thirdparty.jj2000.j2k.encoder
 * package. It is used to avoid having to list the whole package hierarchy in
 * the java virtual machine command line.
 */
public enum JJ2KEncoder {
	;
