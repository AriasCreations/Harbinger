...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.codestream.HeaderInfo.COM;
...
public class ImgDecoder
{
			...
			ICCProfileException
	{
		...
		{ // Skip dev.zontreck.harbinger.thirdparty.jj2000.j2k.colorspace mapping
			return ictransf;
		}
	...
	public String[] getCOMInfo()
	{
		...
		Iterator<COM> iterator = hi.com.values().iterator();
