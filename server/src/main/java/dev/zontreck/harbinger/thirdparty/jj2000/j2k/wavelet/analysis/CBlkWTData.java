 ...
 *
 * @see CBlkWTDataSrc
 * @see dev.zontreck.harbinger.thirdparty.jj2000.j2k.quantization.quantizer.CBlkQuantDataSrcEnc
 * @see DataBlk
 * @see CBlkWTDataInt
 * @see CBlkWTDataFloat
 */
public abstract class CBlkWTData {
	...
	public String toString ( ) {
		...
		return "CBlkWTData: ulx=" + this.ulx + ", uly=" + this.uly + ", code-block(" + this.m + "," + this.n + "), width=" + this.w
				+ ", height=" + this.h + ", offset=" + this.offset + ", scan-width=" + this.scanw + ", type=" + typeString
				+ ", wmseScaling= " + this.wmseScaling + ", convertFactor=" + this.convertFactor + ", stepSize=" + this.stepSize
				+ ", magbits=" + this.magbits + ", nROIcoeff=" + this.nROIcoeff + ", nROIbp=" + this.nROIbp;
	}
}
