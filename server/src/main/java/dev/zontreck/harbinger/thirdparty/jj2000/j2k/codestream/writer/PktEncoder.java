...
public class PktEncoder {
	 ...
	 * </ul>
	 */
	private final TagTreeEncoder[][][][][] ttIncl;
	 ...
	 * </ul>
	 */
	private final TagTreeEncoder[][][][][] ttMaxBP;
	...
	public void save ( ) {
		...
		TagTreeEncoder[][][] ttMaxBP_t_c;
		TagTreeEncoder[][] ttIncl_t_c_r;
		TagTreeEncoder[][] ttMaxBP_t_c_r;
		int[][][] lblock_t_c;
		int[][][] bak_lblock_t_c;
		int[][] prevtIdxs_t_c_r;
