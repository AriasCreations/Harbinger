...
public abstract class BitstreamReaderAgent implements CodedCBlkDataSrcDec
{
	 ...
	 */
	public static BitstreamReaderAgent createInstance(final RandomAccessIO in, final HeaderDecoder hd, final ParameterList pl,
													  final DecoderSpecs decSpec, final boolean cdstrInfo, final HeaderInfo hi) throws IOException
	{

		// Check parameters
		pl.checkList(OPT_PREFIX,
