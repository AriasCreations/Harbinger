 ...
 * @author Bruce A. Kern
 * @version 1.0
 * @see dev.zontreck.harbinger.thirdparty.jj2000.j2k.icc.RestrictedICCProfile
 * @see dev.zontreck.harbinger.thirdparty.jj2000.j2k.icc.lut.LookUpTableFP
 */
...
public class MonochromeTransformTosRGB {
	...
	private final int dwInputMaxValue;
	private final LookUpTableFP fLut;
	...
	public MonochromeTransformTosRGB ( final RestrictedICCProfile ricc , final int dwInputMaxValue , final int dwInputShiftValue ) {
		...
		for ( ; i <= dwInputMaxValue ; i++ )
			this.lut[ i ] = ( short ) (
					Math.floor ( MonochromeTransformTosRGB.ksRGB8ScaleAfterExp * Math.pow ( this.fLut.lut[ i ] , MonochromeTransformTosRGB.ksRGBExponent )
