 ...
 */
package dev.zontreck.harbinger.thirdparty.jj2000.j2k.image.invcomptransf;
...
public class InvCompTransf extends ImgDataAdapter implements BlkImgDataSrc {
	 ...
	 */
	private final boolean noCompTransf;
	/**
	 ...
	 * @param ttype   The type ID of the inverse component transformation
	...
	private DataBlk invRCT ( final DataBlk blk , final int c ) {
		...
		else if ( ( 0 <= c ) && ( 3 > c ) ) { // Asking for the 2nd or 3rd block component
			blk.setData ( this.outdata[ c ] );
