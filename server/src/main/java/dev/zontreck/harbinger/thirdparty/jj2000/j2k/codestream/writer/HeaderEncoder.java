...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.encoder.Encoder;
...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.entropy.encoder.EBCOTRateAllocator;
...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.quantization.quantizer.StdQuantizer;
...
public class HeaderEncoder implements Markers, StdEntropyCoderOptions {
	 ...
	 */
	private final String otherCOMMarkSeg;
	/**
	 ...
	 *
	 * @param origsrc   The original image data (before any component mixing, tiling,
	 *                  etc.)
	 * @param isorigsig An array specifying for each component if it was originally
	 *                  signed or not.
	...
	public HeaderEncoder (
			final ImgData origsrc , final boolean[] isorigsig , final ForwardWT dwt , final Tiler tiler , final EncoderSpecs encSpec ,
	...
	private void writeSIZ ( ) throws IOException {
		...
		for ( int c = 0 ; c < this.nComp ; c++ ) { // Loop on each component
