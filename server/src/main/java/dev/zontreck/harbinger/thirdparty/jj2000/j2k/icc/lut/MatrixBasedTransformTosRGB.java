...
import dev.zontreck.harbinger.thirdparty.jj2000.j2k.icc.RestrictedICCProfile;
 ...
 * @author Bruce A. Kern
 * @version 1.0
 * @see dev.zontreck.harbinger.thirdparty.jj2000.j2k.image.DataBlkInt
 * @see dev.zontreck.harbinger.thirdparty.jj2000.j2k.image.DataBlkFloat
 */
	...
	public void apply ( final DataBlkFloat[] inb , final DataBlkFloat[] outb ) throws MatrixBasedTransformException {
		...
		for ( int y = 0 ; y < inb[ 0 ].h ; ++ y ) {
			...
			while ( index < end ) {
				...
				// final LUT.
				val = ( int ) (
						this.matrix[ MatrixBasedTransformTosRGB.M00 ] * this.fBuf[ MatrixBasedTransformTosRGB.RED ][ index ] + this.matrix[ MatrixBasedTransformTosRGB.M01 ] * this.fBuf[ MatrixBasedTransformTosRGB.GREEN ][ index ] + this.matrix[ MatrixBasedTransformTosRGB.M02 ]
				...
				val = ( int ) (
						this.matrix[ MatrixBasedTransformTosRGB.M10 ] * this.fBuf[ MatrixBasedTransformTosRGB.RED ][ index ] + this.matrix[ MatrixBasedTransformTosRGB.M11 ] * this.fBuf[ MatrixBasedTransformTosRGB.GREEN ][ index ] + this.matrix[ MatrixBasedTransformTosRGB.M12 ]
								* this.fBuf[ MatrixBasedTransformTosRGB.BLUE ][ index ] + 0.5
				);
				// Clip the calculated value if necessary..
				if ( 0 > val )
				...
				val = ( int ) (
						this.matrix[ MatrixBasedTransformTosRGB.M20 ] * this.fBuf[ MatrixBasedTransformTosRGB.RED ][ index ] + this.matrix[ MatrixBasedTransformTosRGB.M21 ] * this.fBuf[ MatrixBasedTransformTosRGB.GREEN ][ index ] + this.matrix[ MatrixBasedTransformTosRGB.M22 ]
								* this.fBuf[ MatrixBasedTransformTosRGB.BLUE ][ index ] + 0.5
				);
				// Clip the calculated value if necessary..
				if ( 0 > val )
