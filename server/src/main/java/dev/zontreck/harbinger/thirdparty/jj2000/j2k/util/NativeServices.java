...
public final class NativeServices {
	 ...
	 * native methods: 'dev.zontreck.harbinger.thirdparty.jj2000'. The actual file name of the library is system
	 ...
	 * @throws IllegalArgumentException Concurrency level is negative
	...
	public static boolean loadLibrary ( ) {
		...
		// Library was found
		NativeServices.libState = NativeServices.LIB_STATE_LOADED;
		return true;
	}
